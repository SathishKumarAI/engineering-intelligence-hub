...
## Project overview
Engineering Intelligence Hub — a RAG service that answers engineering questions over
internal technical docs (RFCs, runbooks, ADRs, API references, wikis) and **cites the
source passage** for every claim. FastAPI backend + Next.js frontend.
...
- Preserve exact technical identifiers (commands, endpoints, versions) verbatim in
  answers — they're load-bearing for engineers.
...
- All sample docs in `data/` are SYNTHETIC — never commit real internal docs.
